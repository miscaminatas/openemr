    ...
    <div class="container-lg">
        ...
        <form id="startForm" role="form" action="account.php?action=verify_email" method="post">
            ...
            <div class="text-center setup-content" id="step-1">
                ...
                <div class="jumbotron">
                    ...
                    <div class="form-row">
                        <div class="col-12 col-md-6 col-lg-3 form-group">
                            ...
                            <input type="text" class="form-control" id="fname" name="fname" required placeholder="<?php echo xla('Primer Nombre'); ?>" />
                        </div>
                        <div class="col-12 col-md-6 col-lg-3 form-group">
                            <label for="mname"><?php echo xlt('Middle Name') ?></label>
                            <input type="text" class="form-control" id="mname" name="mname" placeholder="<?php echo xla('Segundo nombre o inicial'); ?>" />
                        </div>
                        <div class="col-12 col-md-6 col-lg-3 form-group">
                            <label for="lname"><?php echo xlt('Last Name') ?></label>
                            <input type="text" class="form-control" id="lname" name="lname" required placeholder="<?php echo xla('Apellidos'); ?>" />
                        </div>
                        <div class="col-12 col-md-6 col-lg-3 form-group">
                            <label for="dob"><?php echo xlt('Birth Date') ?></label>
                            <input id="dob" type="text" required class="form-control datepicker" name="dob" placeholder="<?php echo xla('DD-MM-YYYY'); ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label" for="emailInput"><?php echo xlt('Ingresar su E-Mail') ?></label>
                        <input id="emailInput" type="email" class="reg-email form-control" name="email" required placeholder="<?php echo xla('Ingrese E-Mail para el proceso de registro.'); ?>" maxlength="100" />
                    </div>
                    <div class="form-group">
                ...
                <button type="submit" id="verifyBtn" class="btn btn-primary pull-right mb-5" type="button" disabled="disabled"><?php echo xlt('Verificar Email') ?></button>
            </div>
        </form>
    </div>
</body>
